  ...
  return (
    <div className="home__data">
        <h1 className="home__title">
            ...
            <h3 className="home__subtitle">Full Stack Developer. <br />Cyber Security enthusiast.</h3>
            <p className="home__description">
            A web developer specializes in building web applications using the react , leveraging its features for rapid development, scalability, and secure database interactions
              </p>
